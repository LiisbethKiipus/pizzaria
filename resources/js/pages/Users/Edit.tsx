...
import { type BreadcrumbItem, type FormUser } from '@/types';
...
export default function Edit({user, userRoles, roles} : { roles: string[],  userRoles: string[], user: FormUser }) {
    ...
    function handleCheckboxChange(roleName: string, checked: boolean): void {
        if (checked) {
