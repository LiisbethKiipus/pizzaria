...
export default function Edit({role, rolePermissions, permissions}: { role: {name:string, id:number}, rolePermissions: string[], permissions: string[]}) {

    const {data, setData, errors, put} = useForm<{name:string, permissions: string[]}>({
        name: role.name||"",
